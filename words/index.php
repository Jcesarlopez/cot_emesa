<?php
session_start();
	// Iniciamos sesion para usar las variables de session que llevan los datos de conexion de la base de datos
		...
		{		
			$.ajax({
				...
				{					 
					...
					$('#divMensajes').html('El usuario y contraseña no coninciden');
				}
...
<body>
	<div id="fondo" class="valign-wrapper center-align mwhite-text">		
			<div id="divCentro">
				...
				{
					if($_GET['param1']=='SessionExpire')
					{
						echo "La sesión expiró";
					}
				}
				?> &nbsp;</div>
					<form>
