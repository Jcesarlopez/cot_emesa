<?	
	...
	$_SESSION['planta']['tipo'];
	$_SESSION['planta']['serie'];
	$_SESSION['planta']['LPS'];
	...
	require "func_java.php";		
	require "/home/emesa/public_html/_iessus/xajax/xajax.inc.php";
	require "Controlador/Controlador.php";
	$xajax = new xajax();

	require "func_xajax.php";		

	//include_once($urlVistas."menuSup.php");
	/*include_once($urlVistas."menuLateral.php"); */
	
	$xajax->registerFunction("mostrarConceptosPTAR");
	$xajax->registerFunction("aceptarPTAR");
	$xajax->registerFunction("mostrar_capacidad_ptar");
	$xajax->registerFunction("mostrar_tipo_ptar");
	$xajax->registerFunction("selec_cliente");
	$xajax->registerFunction("filtrar_clientes");	
...
<head>
	  ...
	  <?php $xajax->printJavascript("http://www.emesa.com.mx/_iessus/xajax/"); ?>
...
<body onload="loadPage();">
	  <header>	  	
	  	...
	  	<style>
	  		...
	  		#divMenuBtn{transform: translateY(10px);}
	  		.toast{background-color: #ef6c00;}
	  	</style>
	  	<div id="DivmenuSup" class="row blue darken-3 white-text center-align">

	  		<div id="divMenuBtn" class="col s4 m2 l1 left-align">
	  			<a href="#" data-activates="slide-out" class=" button-collapse btn-floating btn-large waves-effect waves-light red"><i class="material-icons">menu</i></a>
	  		</div>
	  		...
	  		<div id="divStatusCot" class="col s4 m4 l4 left-align"><br>
			 ...
			 <div class="card blue darken-3 white-text">
		            <div class="card-content CardsSup">
		              ...
		              <p>		              	
				          ...
				          <input id="birthdate" type="text" class="colorBordeInput datepicker picker__input picker__input--active center-align" readonly="" tabindex="-1" aria-haspopup="true" aria-expanded="true" aria-readonly="false" aria-owns="birthdate_root">
	...
	<div class="col m12 l12 ">
		 <div class="card blue darken-3 white-text">
	        <div class="card-content CardsPTAR valign-wrapper">
	          <div class="titleCard">
	         	 <a href="#modalPTAR"  onclick="selPTAR(1,0,0,0)" class="modal-trigger waves-effect waves-light btn red">Planta de Tratamiento</a>   	
	          </div>	         
	        </div>	            
	      </div>
	</div> 
 ...
 <div id="modalPTAR" class="modal">	
	 ...
	 <div id="modalBuscaClienteWeb" class="modal">
	   ...
	   <ul id="slide-out" class="side-nav">
    	...
    	<li><div class="divider"></div></li>
    	<li><a class="waves-effect modal-trigger" href="#modalAbrirCot" onclick="ListadoDefaultCot();"><i class="fa fa-folder-open" aria-hidden="true"></i> Abrir</a></li>

    	<li><div class="divider"></div></li>
    	<li><a class="waves-effect" onclick="guardar()" href="#!"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</a></li>
    	<li><div class="divider"></div></li>


    	<li><a class="waves-effect" href="#!"><i class="fa fa-window-close-o" aria-hidden="true"></i> Cerrar</a></li>
    	<li><div class="divider"></div></li>


    	<li><a class="waves-effect" onclick="word()" href="#!"><i class="fa fa-file-word-o" aria-hidden="true"></i> Descargar</a></li>
    	<li><div class="divider"></div></li>
    	<li><a class="waves-effect" href="index2.php"><i class="fa fa-sign-out" aria-hidden="true"></i> Salir</a></li>
    	<li><div class="divider"></div></li>
	  </ul>
