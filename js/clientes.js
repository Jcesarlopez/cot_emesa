function adaptarContac(valor)
{
	
	//$('#contactosCl').prop('checked',true);
...
function CambiarContacSel(c1,c2,c3)
{
	var contacSel = "";
	if(c1){contacSel = $("#labelContacto1").html();}
	if(c2){contacSel = $("#labelContacto2").html();}
	if(c3){contacSel = $("#labelContacto3").html();}
	$("#spanNomContactocliente").html(contacSel);
...
$.ajax({
		...
		{			
			...
			if(valores[i]['Contacto'] == "")
			{
				$('#pContacto1').css('visibility', 'hidden');
			}else
			{
				$('#pContacto1').css('visibility', 'visible');
				$("#labelContacto1").html(valores[i]['Contacto'].toUpperCase());
			}

			if(valores[i]['Contacto2'] == "")
			{
				$('#pContacto2').css('visibility', 'hidden');
			}else
			{
				$('#pContacto2').css('visibility', 'visible');
				$("#labelContacto2").html(valores[i]['Contacto2'].toUpperCase());
			}
			
			if(valores[i]['Contacto3'] == "")
			{
				$('#pContacto3').css('visibility', 'hidden');
			}else
			{
				$('#pContacto3').css('visibility', 'visible');
				$("#labelContacto3").html(valores[i]['Contacto3'].toUpperCase());
			}
	...
	$.ajax({
		...
		if(paso==1)
			...
			{	
				...
				$("#divStatusCot").html("<br>Nueva cotización - Planta de Tratamiento");
			}
