...
if($_SESSION['PTARPropiedades']['IdTipo']==1) // PK
{
	...
	$arrayNotas2[]='12. L.A.B. Cuernavaca.';
...
if($_SESSION['PTARPropiedades']['IdTipo']==2) // Obra civil
{
	...
	$arrayNotas2[]='2. Las Plantas con nuestra tecnología, ha demostrado su prácticamente nula producción de lodos, razón por la que no se está incluyendo sistema de tratamiento de lodos.';
