...
if($_SESSION['PTARPropiedades']['IdTipo']==1) // PK
{
	...
	$arrayNotas1[]="(5) El área especificada es para la planta de tratamiento. No incluye vialidades ni jardinería. Las dimensiones finales son las que resulten del proyecto ejecutivo.";
	$arrayNotas1[]="(6) Esta planta utiliza una conexión trifásica a 220volts. En caso de que no cuenten con este tipo de conexión, nos lo tendrá que hacer saber antes de su fabricación  para adecuar los equipos.";
}
