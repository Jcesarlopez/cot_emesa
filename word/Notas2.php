...
if($_SESSION['PTARPropiedades']['IdTipo']==1) // PK
{
	...
	$arrayNotas2[]='4. Requiere losa para apoyo e instalación de la planta en terreno firme y plano, con capacidad de carga mínima de 4 Ton/m2, misma deberá ser notificada por medio de correo u oficio por escrito acompañado de fotografías que la acredite de acuerdo a las especificaciones';
...
if($_SESSION['PTARPropiedades']['IdTipo']==2) // Obra civil
{
	...
	$arrayNotas2[]='14. El cliente deberá notificar por medio de correo u oficio por escrito acompañado de fotografías que acredite la plantilla de acuerdo a las especificaciones';
	$arrayNotas2[]='15. El tiempo de entrega de la obra, será de acuerdo al programa de obra. Y este iniciará a partir de que el cliente entregue la plantilla en las condiciones antes descritas de la planta de tratamiento y del pretratamiento. La demora en la entrega de cualquiera de ellas retrasará el programa en ese mismo tiempo.';
	$arrayNotas2[]='16. Una vez terminada la obra el cliente deberá suministrar a los tanques agua residual o agua limpia para realizar las pruebas de estanqueidad y en caso de que la planta no se arranque las estructuras de obra civil deberán permanecer llenas de agua hasta la fecha de arranque para evitar fisuras en la estructura.';
	$arrayNotas2[]='17. No se incluye en esta cotización el costo de seguro o fianzas, en caso de ser requeridas por el cliente se cotizarán por separado y adicionado al precio de esta cotización.';
}
